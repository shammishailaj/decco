...
func (r *AppReconciler) prepareApp(ctx context.Context, app *deccov1.App) error {
	...
	if err != nil {
		app.Status.SetPhase(deccov1.AppPhaseError)
...
func (r *AppReconciler) getOwningSpace(ctx context.Context, app *deccov1.App) (*deccov1.Space, error) {
